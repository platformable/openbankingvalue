...
const Tool = ({data}) => {
  ...
  const [isfilteredCategoryListActive,setfilteredCategoryListActive]=useState(true)
...
useEffect(()=>{
  ...
  function getData(){
    fetch('https://api.airtable.com/v0/appHMNZpRfMeHIZGc/LOOKUP%20Stakeholders',{
      method:'GET',
      headers:{
    ...
    >
      <span className="flex items-center">
        ...
        <span className="ml-3 block truncate">
          {selectedTypeOfValue ? selectedTypeOfValue : "Select type of value"}
        </span>
      </span>
...
export async function getStaticProps(context) {
    const res = await fetch(`https://api.airtable.com/v0/appHMNZpRfMeHIZGc/Value%20Generated`,{
        method: 'GET',
        headers:{
            'Content-Type': 'application/json',
